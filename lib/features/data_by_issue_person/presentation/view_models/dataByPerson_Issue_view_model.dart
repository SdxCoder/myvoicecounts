...
import 'package:myvoicecounts/features/data_by_issue_person/services/data_person_issue_service.dart';

import '../../data/queryData.dart';

class DataByPersonIssueViewModel extends BaseModel{
  ...
  Future fetchData(period, String issueId,String personId) async {
    setBuzy(true);
    var result = await _service.fetchData(period, issueId, personId);
   if(result is String){
      ...
      if(result is QueryPersonIssueData){ 
         data = result;
