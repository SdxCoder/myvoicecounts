...
class IssueViewTablet extends StatelessWidget {
  ...
  const IssueViewTablet({Key key, this.model, this.candidate}) : super(key: key);
  @override
      ...
      children: <Widget>[
        ...
        ButtonBar(
          children: <Widget>[
            ...
            InkWell(
                onTap: () {
                   model.voteForPersonIssue(issue,candidate, 'disagree');
                },
            ...
            InkWell(
                onTap: () {
                   model.voteForPersonIssue(issue, candidate,'undecided');
                },
