...
import '../widgets/piechart_candidate.dart';
...
class DataViewMobile extends StatelessWidget {
            ...
            Container(
              ...
              child: Padding(
                ...
                child: GridView.count(
                  ...
                  children: <Widget>[
                    _buildGrapghByTopAge(context, sizingInfo),
                    _buildGrapghByGender(context, sizingInfo),
                    _buildGrapghForCandidate(context, sizingInfo)
                  ],
                ),
              ),
            ),
  ...
  Widget _buildGrapghByTopAge(context, SizingInformation sizingInfo) {
    return Padding(
  ...
  Widget _buildGrapghByGender(context, SizingInformation sizingInfo) {
    return Padding(
      padding: const EdgeInsets.all(16.0),
      child: Column(
        children: <Widget>[
          ...
          Expanded(
            child: GroupedTopAgeGraph.withGenderData(),
          )
        ],
      ),
    );
    ...
    Widget _buildGrapghForCandidate(context, SizingInformation sizingInfo) {
    return Padding(
      padding: const EdgeInsets.all(16.0),
      child: Column(
        children: <Widget>[
